package jp_bueno.buildrun.dynamodb.entity;

import jp_bueno.buildrun.dynamodb.controller.ScoreDTO;
...
public class PlayerHistoryEntity {
    ...
    public static PlayerHistoryEntity fromScore(String username, ScoreDTO score) {
