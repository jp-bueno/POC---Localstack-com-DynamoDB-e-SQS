package jp_bueno.buildrun.dynamodb.controller;

import io.awspring.cloud.dynamodb.DynamoDbTemplate;
import jp_bueno.buildrun.dynamodb.entity.PlayerHistoryEntity;
...
public class PlayerController {
    ...
    public ResponseEntity<PlayerHistoryEntity> findById(@PathVariable("username") String username,
        ...
        var entity = dynamoDbTemplate.load(Key.builder()
                        .partitionValue(username)
                        .sortValue(gameId)
                .build(), PlayerHistoryEntity.class); // Busca à partir de uma chave
